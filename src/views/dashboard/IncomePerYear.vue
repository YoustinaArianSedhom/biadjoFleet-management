<template>
  <e-charts autoresize :options="option" ref="line" auto-resize />
</template>
...
export default {
  ...
  methods: {
    IncomePerYear() {
      ...
      this.$store.dispatch("Dashboard/IncomeForYear", Obj).then(res => {
